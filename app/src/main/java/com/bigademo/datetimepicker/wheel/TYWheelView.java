...
import com.bigademo.datetimepicker.wheel.adapter.TYWheelAdapter;
 ...
 * 3d滚轮控件
 */
public class TYWheelView extends View
{
	...
	TYOnItemSelectedListener onItemSelectedListener;
	...
	public TYWheelView(Context context)
	{
		this(context, null);
	}

	public TYWheelView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	private void initLoopView(Context context)
	{
		...
		handler = new TYMessageHandler(this);
		gestureDetector = new GestureDetector(context, new TYLoopViewGestureListener(this));
	...
	void smoothScroll(ACTION action)
	{
		...
		mFuture = mExecutor.scheduleWithFixedDelay(new TYSmoothScrollTimerTask(this, mOffset), 0, 10, TimeUnit.MILLISECONDS);
	}
	...
	protected final void scrollBy(float velocityY)
	{
		...
		mFuture = mExecutor.scheduleWithFixedDelay(new TYInertiaTimerTask(this, velocityY), 0, VELOCITYFLING, TimeUnit.MILLISECONDS);
	}
	...
	public final void setOnItemSelectedListener(TYOnItemSelectedListener OnItemSelectedListener)
	{
		this.onItemSelectedListener = OnItemSelectedListener;
	}

	public final void setAdapter(TYWheelAdapter adapter)
	{
	...
	public final TYWheelAdapter getAdapter()
	{
		return adapter;
	}
	...
	protected final void onItemSelected()
	{
		...
		{
			postDelayed(new TYOnItemSelectedRunnable(this), 200L);
		}
	}
